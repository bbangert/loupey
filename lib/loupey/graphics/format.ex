defmodule Loupey.Graphics.Format do
  ...
  """
  @spec to_device_format(Vix.Vips.Image.t(), Loupey.Device.Display.pixel_format()) :: binary()
  ...
  """
  @spec to_rgb565(Vix.Vips.Image.t()) :: binary()
  ...
  """
  @spec to_jpeg(Vix.Vips.Image.t(), pos_integer()) :: binary()
  def to_jpeg(image, quality \\ 90) do
    {:ok, {_format, binary}} =
      Vix.Vips.Operation.jpegsave_buffer(image, Q: quality)
  ...
  """
  @spec to_rgb888(Vix.Vips.Image.t()) :: binary()
